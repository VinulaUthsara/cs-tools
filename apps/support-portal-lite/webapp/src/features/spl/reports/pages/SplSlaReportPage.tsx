...
// Ported from one-wso2's features/spl/reports/pages/SplSlaReportPage.tsx
// (itself ported from the source app's pages/SLAReport.tsx). Route:
// projects/:projectId/sla-report/:sysId.
//
