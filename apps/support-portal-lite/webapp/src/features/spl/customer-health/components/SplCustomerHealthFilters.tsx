...
// Ported from one-wso2's SplCustomerHealthFilters.tsx, restyled onto
// @wso2/oxygen-ui.
...
export default function SplCustomerHealthFilters({ onFilterChange, currentFilters }: SplCustomerHealthFiltersProps) {
  ...
  // useAsgardeoUser decodes the same id_token claim in this app's own
  // session (see src/hooks/useAsgardeoUser.ts).
