...
// Ported from one-wso2's SplCustomerHealthDashboardPage.tsx, restyled onto
// @wso2/oxygen-ui.
import { useState, useEffect } from "react";
import { Box, Alert } from "@wso2/oxygen-ui";
...
function CustomerHealthDashboardContent() {
  ...
  return (
    <Box>
      <PageHeader title="Customer Health Dashboard" subtitle="Monitor account parameters and identify risks" />
