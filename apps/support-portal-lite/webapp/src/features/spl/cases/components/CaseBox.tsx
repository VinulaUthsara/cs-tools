...
// Ported from the source app's components/CaseBox.tsx (via one-wso2's
// plain-MUI port) — the comments/worknotes feed shown under a case's
// work-note composer. Rebuilt on @wso2/oxygen-ui.
