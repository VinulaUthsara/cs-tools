...
// Ported from the source app's components/CaseStateView.tsx (via one-wso2's
...
export default function CaseStateView({
  ...
  // No "/csm" prefix here — this app's own routes are plain "cases/:caseId"
  // (see App.tsx's comment on why, unlike one-wso2's "support-cases").
  const handleRowClick = (rowData: CaseDetails) => navigate(`/cases/${rowData.number}`);
