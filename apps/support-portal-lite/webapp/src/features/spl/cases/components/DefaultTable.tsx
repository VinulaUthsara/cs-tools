...
// Ported from the source app's components/DefaultTable.tsx (via one-wso2's
// plain-MUI port of the same file) — generic, reusable paginated table.
// Kept local to features/spl/cases/ (not shared across domains) to avoid
// cross-domain file collisions, same as one-wso2's own port.
