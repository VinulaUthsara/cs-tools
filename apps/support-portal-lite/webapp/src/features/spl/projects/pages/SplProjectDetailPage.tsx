...
// Routed at both /projects/:projectId and
// /accounts/:accountId/projects/:projectId (the source app has the same two
// entry points) — only `projectId` is ever read; ProjectDetailView resolves
// the account context itself from the project record.
