...
// Ported from one-wso2's features/spl/schedule/pages/SplTeamSchedulePage.tsx
// (itself ported from SupportPortalLite's src/pages/ScheduleTable.tsx),
// restyled onto @wso2/oxygen-ui. Routed at both team-schedule and
// team-schedule/:sysId (see App.tsx).
      ...
      <Box sx={{ display: "flex", gap: 4, alignItems: "center", margin: "15px" }}>
        <Box sx={{ display: "flex", gap: 4, alignItems: "center", margin: "15px", width: "70%" }}>
          ...
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DatePicker label="From" value={dayjs(from)} onChange={(v) => handleFromChange(v as Dayjs | null)} />
